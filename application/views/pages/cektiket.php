              ...
              <div class="row">
                <div class="col-4">
                  <div class="form-group row">
                    <div class="col-sm-7">
                      <input type="text" class="form-control date" id="tgl_berangkat" onChange="REFRESH_DATA()" value="<?php echo date("Y-m-d"); ?>" placeholder="Tanggal Keberangkatan">
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
            ...
            <form id="FRM_DATA">
              ...
              <div class="card-body">
                <div class="form-group">
                  <h5>Masukkan / Scan Nomor Tiket</h5>
        ...
        <div class="col-8" id="lst_show" style="display: none;">
          <div class="card" style="margin-top: 1rem">
            ...
            <!-- /.card-body -->
            <div class="card-footer text-right">
              <button type="submit" class="btn btn-warning" id="BTN_CLOSE">Close</button>
            </div>
          </div>
          <!-- /.card -->
        </div>
...
<script>
  ...
  $(function(){
    ...
    $("#FRM_DATA").on('submit', function(event){
      ...
      $.ajax({
        url: "<?php echo site_url('jadwal_tiket/getTiketById') ?>",
        type: "POST",
        data: {
  ...
  function REFRESH_DATA(){
    $.ajax({
      url: "<?php echo site_url('jadwal_tiket/getJadwalByDate') ?>",
      dataType: "JSON",
      type: "POST",
      data: {
