...
<script>
  ...
  $(function () {
    ...
    $("#BTN_SAVE").click(function(){
      ...
      if(save_method == 'save') {
          urlPost = "<?php echo site_url('parameter_kepuasan/saveData') ?>";
      }else{
          urlPost = "<?php echo site_url('parameter_kepuasan/updateData') ?>";
          formData+="&id_parameter="+id_edit
      }
  ...
  function REFRESH_DATA(){
    ...
    var tb_data = $("#tb_data").DataTable({
      ...
      "pageLength": 25,
      "ajax": {
          "url": "<?php echo site_url('parameter_kepuasan/getAllData') ?>",
          "type": "GET"
      },
      "columns": [
          {
          ...
          { "data": null, 
            "render" : function(data){
              return "<button class='btn btn-sm btn-warning' onclick='editData("+JSON.stringify(data)+");'><i class='fas fa-edit'></i> Edit</button> "+
                "<button class='btn btn-sm btn-danger' onclick='deleteData(\""+data.id_parameter+"\");'><i class='fas fa-trash'></i> Delete</button>"
            },
  ...
  function deleteData(id){
    ...
    urlPost = "<?php echo site_url('parameter_kepuasan/deleteData') ?>";
    formData = "id_parameter="+id
    ACTION(urlPost, formData)
  }
</script>