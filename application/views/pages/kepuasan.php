      ...
      <div class="row">
        <div class="col-8">
          <div class="card" style="margin-top: 1rem">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <a href="<?php echo base_url('kepuasan/addKepuasan') ?>" class="btn btn-sm btn-info" style="margin-bottom: 10px;" ><i class="fas fa-plus-circle"></i> Tambah</a>
...
<script>
  ...
  function deleteData(id){
    ...
    urlPost = "<?php echo site_url('kepuasan/deleteData') ?>";
  ...
  function ISI_TIKET(){
    $.ajax({
      url: "<?php echo site_url('kepuasan/getTiket') ?>",
      type: "POST",
      dataType: "JSON",
      success: function(data){
        // console.log(data)
  ...
  function hitungKepuasan(){
    $.ajax({
      url: "<?php echo site_url('kepuasan/getNilaiKepuasan') ?>",
      type: "POST",
      data: {
