...
<script>
  ...
  $(function () {
    ...
    $("#BTN_SAVE").click(function(){
      ...
      if(save_method == 'save') {
          urlPost = "<?php echo site_url('kategori_bus/saveData') ?>";
      }else{
          urlPost = "<?php echo site_url('kategori_bus/updateData') ?>";
          formData+="&id_kategori="+id_edit
      }
  ...
  function REFRESH_DATA(){
    ...
    var tb_data = $("#tb_data").DataTable({
      ...
      "pageLength": 25,
      "ajax": {
          "url": "<?php echo site_url('kategori_bus/getAllData') ?>",
          "type": "GET"
      },
      "columns": [
          {
          ...
          { "data": null, 
            "render" : function(data){
              return "<button class='btn btn-sm btn-warning' onclick='editData("+JSON.stringify(data)+");'><i class='fas fa-edit'></i> Edit</button> "+
                "<button class='btn btn-sm btn-danger' onclick='deleteData(\""+data.id_kategori+"\");'><i class='fas fa-trash'></i> Delete</button>"
            },
  ...
  function deleteData(id){
    ...
    urlPost = "<?php echo site_url('kategori_bus/deleteData') ?>";
