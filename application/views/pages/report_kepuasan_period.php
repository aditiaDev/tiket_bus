        ...
        <div class="col-12">
          <div class="card" style="margin-top: 1rem">
            <div class="card-header">
              <h3 class="card-title">Kepuasan Pelanggan Periodic</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <form action="<?php echo base_url('report/ctkKepuasanPeriod') ?>" method="POST" target="_blank">
                <div class="row">
                    <div class="col-3" style="margin-bottom: 10px;">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">No. Bus</label>
                        <div class="col-sm-9">
  ...
  $(function () {
    ...
    $("#btnCari").click(function(){
      ...
      var tb_data = $("#tb_data").DataTable({
        ...
        "pageLength": 25,
        "ajax": {
            "url": "<?php echo site_url('report/getKepuasanPeriod') ?>",
            "data": {
